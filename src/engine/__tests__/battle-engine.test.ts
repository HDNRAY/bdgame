...
describe('BattleEngine', () => {
    it('should simulate a fight and determine a winner', () => {
        ...
        const opponent = new Character('o1', '野怪', {
            strength: 8,
            vitality: 8,
            dexterity: 6,
            technique: 6,
    ...
    it('should handle distance management', () => {
        const player = new Character('p1', '远程', {
            technique: 12,
            dexterity: 14,
            strength: 6,
            vitality: 8,
        ...
        const opponent = new Character('o1', '近战', {
            strength: 14,
            vitality: 10,
            dexterity: 8,
            technique: 6,
    ...
    it('should end when a character dies', () => {
        const weak = new Character('weak', '弱者', {
            strength: 3,
            vitality: 3,
            dexterity: 3,
            technique: 3,
        ...
        const strong = new Character('strong', '强者', {
            strength: 18,
            vitality: 20,
            dexterity: 10,
            technique: 14,
