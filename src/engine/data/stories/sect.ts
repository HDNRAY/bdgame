...
export const SECT: Story = {
    ...
    tags: [],
    comment:
        'n11(9岁/师兄10岁)＝师兄假死被组织带走｜n14(扶桑门第1天)＝抵达扶桑门，与桑原切磋试手｜n15(扶桑门第2天)＝观看一刀与腊月的表演赛，随后比武大会正式开始，台下看到乔装师兄，朵儿断后｜n16(9年后)＝追踪师兄至巷中，中毒，产生"执念"｜n19(3年后)＝调查非法义体交易时看到朵儿，得知组织要渗透斗炁大会｜n22＝随机对手（除军师/朵儿）｜最终Boss＝军师（师兄，被洗脑身居高位）。朵儿：高根骨用毒，师兄的搭档。扶桑门：一刀为掌门，桑原为其弟子，门派承办比武大会。',
