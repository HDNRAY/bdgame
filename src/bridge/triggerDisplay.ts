...
const TRIGGER_NAMES: Record<string, string> = {
    ...
    on_disarm: '缴械时',
    on_disarmed: '被缴械时',
    on_move_closer: '自己靠近时',
    on_move_away: '自己远离时',
    on_opponent_move_closer: '对手靠近时',
    on_opponent_move_away: '对手远离时',
    on_crit: '暴击时',
    on_turn_end: '回合结束时',
    battle_start: '战斗开始时',
    on_buff: '获得增益时',
...
const TRIGGER_DESCS: Record<string, string> = {
    ...
    on_hit: '攻击命中时触发',
    on_summon_hit: '召唤物攻击命中时触发',
    on_was_crit: '被暴击命中时触发',
    on_dodge: '闪避对手攻击时触发',
    on_attack: '攻击时触发',
    on_dealt_damage: '造成伤害时触发',
    on_was_hit: '被攻击命中时触发',
    on_took_damage: '实际掉血时触发',
