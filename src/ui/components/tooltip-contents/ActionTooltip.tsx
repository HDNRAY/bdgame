    ...
    return (
        <div style={{ position: 'relative' }}>
            ...
            <div className="tt-extra">
                ...
                {action.bonus && `${action.target !== undefined || action.chance !== undefined ? ' · ' : ''}附赠`}
                {action.range &&
                    `${action.target !== undefined || action.chance !== undefined || action.bonus ? ' · ' : ''}范围 ${action.range[0]}~${action.range[1]}`}
