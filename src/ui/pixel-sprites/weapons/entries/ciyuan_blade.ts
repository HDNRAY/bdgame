/**
 * 武器「ciyuan_blade」：美术叠加层 + 各姿势挂点配置（一个武器一个文件）。
 *
...
export const ciyuan_blade: { overlay?: WeaponOverlay; art?: WeaponArtTable; poses: WeaponPoseTable } = { poses: makePoses({ gripX: 8, gripY: 7 }) }
