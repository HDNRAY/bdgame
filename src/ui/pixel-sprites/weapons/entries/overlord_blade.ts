/**
 * 武器「overlord_blade」：美术叠加层 + 各姿势挂点配置（一个武器一个文件）。
 *
...
export const overlord_blade: { overlay?: WeaponOverlay; art?: WeaponArtTable; poses: WeaponPoseTable } = { poses: makePoses({ gripX: 9, gripY: 7 }) }
