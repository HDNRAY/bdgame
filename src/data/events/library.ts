    ...
    rounds: [
        {
            ...
            choices: [
                { id: 'dragon_reward', type: 'continue', label: '找龙女请教防御功法' },
        ...
        },
        {
            ...
            title: '龙女的推荐',
            description:
                '"防御功法是吧？" 龙女放下书，走到一排书架前，指尖划过书脊，"这几本适合你——好好练，别出去让人揍得鼻青脸肿，丢我的人。"',
            choices: [],
        ...
        },
        {
            id: 'dragon_epilogue',
            title: '龙女的赠言',
            description: '龙女把功法抄本塞到你手里："练熟了再来，我这还有更好的。" 她摆摆手，又窝回柜台后面看书去了。',
