    ...
    rounds: [
        {
            ...
            title: '抵达归海楼',
            description:
                '归海楼山门前人声鼎沸。你递上请帖，小厮领你入座。台上桑原正在与人过招，兵刃带风。你找了个角落坐下，认真看每一场。',
        ...
        },
        {
            ...
            title: '观战切磋',
            description:
                '几轮切磋下来，你对各家路数有了新的理解。归海楼掌门一刀亲自下场，与一位老道走了几招，满座喝彩。',
            choices: [
    ...
    rounds: [
        {
            ...
            title: '绝顶观战',
            description:
                '青山绝顶上，六道人影分立各方，谁也没有先动。你远远望着，大气都不敢出。',
        ...
        },
        {
            ...
            title: '绝世之战',
            description:
                '六人交手，每一招都让你心头一震。你拼命记住那些身法与轨迹。战斗结束后，其中一人朝你这边看了一眼，微微点头，然后转身离去。',
