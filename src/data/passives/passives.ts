...
export const PASSIVES: Passive[] = [
    ...
    },
    {
        ...
        tags: ['buff', 'defense'],
        effects: [{ type: 'add_buff', buffId: 'iron_defense' }],
    },
    {
        id: 'ji_lie_zhi_lie',
        name: '极烈之烈',
    ...
    },
    {
        ...
        tags: ['summon'],
        effects: [{ type: 'add_buff', buffId: 'spirit_resonance_buff' }],
    },
    {
        id: 'sword_dominion',
        name: '御剑诀',
        ...
        effects: [{ type: 'add_buff', buffId: 'sword_dominion' }],
    },
    {
        id: 'last_sword',
        name: '绝剑诀',
    ...
    },
    {
        ...
        effects: [{ type: 'add_buff', buffId: 'iaijutsu_ready_buff' }],
    },
    {
        id: 'yi_dao_liu',
        name: '一刀流',
    ...
    },
    {
        ...
        tags: ['defense', 'buff'],
        effects: [{ type: 'add_buff', buffId: 'elemental_immunity' }],
    },
    {
        id: 'frost_mastery',
        name: '冰霜诀',
...

    {
        ...
        tags: ['defense', 'buff'],
        effects: [{ type: 'add_buff', buffId: 'ordinary_training' }],
    },
    {
        id: 'daily_grind',
        name: '日复一日的训练',
        ...
        tags: ['defense'],
        effects: [{ type: 'add_buff', buffId: 'daily_grind' }],
    },
    {
        id: 'momentum_mastery',
        name: '刃炁精通',
    ...
    },
    {
        ...
        effects: [{ type: 'add_buff', buffId: 'overlord_art_buff' }],
    ...
    },
    {
        ...
        tags: ['buff', 'pierce'],
        effects: [{ type: 'add_buff', buffId: 'yi_dian_po_xiao_buff' }],
    },
    {
        id: 'inner_power',
        name: '归元劲',
    ...
    },
    {
        ...
        effects: [{ type: 'add_buff', buffId: 'tai_chi' }],
    },
    {
        id: 'godspeed',
        name: '疾风迅雷',
    ...
    },
    {
        ...
        effects: [{ type: 'add_buff', buffId: 'thunder_bonus' }],
    },
    {
        id: 'zoldyck_art',
        name: '周氏秘法',
    ...
    },
    {
        ...
        tags: ['buff', 'electric'],
        effects: [{ type: 'add_buff', buffId: 'hui_lei_qian' }],
    },
    {
        id: 'baihu_ding',
        name: '白虎定',
        ...
        effects: [{ type: 'add_buff', buffId: 'baihu_ding' }],
    },
    {
        id: 'qiti_source',
        name: '炁体源流',
    ...
    },
    {
        ...
        effects: [{ type: 'add_buff', buffId: 'yue_nv_buff' }],
    },
    {
        ...
        effects: [{ type: 'add_buff', buffId: 'bu_zhi_yu_wu' }],
    },
    // ── 杨过 ──
    {
        id: 'one_arm',
        ...
        effects: [{ type: 'add_buff', buffId: 'one_arm_buff' }],
    },
    {
    ...
    },
    {
        ...
        effects: [{ type: 'add_buff', buffId: 'tide_power', stacks: 0 }],
    },
    {
        id: 'shenxing_baibian',
        name: '神行百变',
    ...
    },
    {
        ...
        effects: [{ type: 'add_buff', buffId: 'stone_skin' }],
    },
    {
        id: 'qishier_bian',
        name: '七十二变',
        ...
        tags: ['buff'],
        effects: [{ type: 'add_buff', buffId: 'qishier_bian', stacks: 0 }],
    },
    {
        id: 'hua_gun',
        name: '舞花棍',
        ...
        effects: [{ type: 'add_buff', buffId: 'hua_gun_parry' }],
    },
    {
    ...
    },
    {
        ...
        tags: ['buff', 'chan'],
        requireAttrsMin: {},
        effects: [{ type: 'add_buff', buffId: 'yuxin_sword_mastery' }],
    },
    {
        id: 'lingxi_finger',
        name: '灵犀一指',
        ...
        effects: [{ type: 'add_buff', buffId: 'lingxi_finger' }],
    },
    {
        id: 'feng_wu_jiu_tian',
        name: '凤舞九天',
    ...
    },
    {
        ...
        tags: ['buff', 'defense'],
        effects: [{ type: 'add_buff', buffId: 'sword_intent_tempering' }],
    },
    {
        id: 'yu_du_shu',
        name: '毒炁外泄',
        ...
        effects: [{ type: 'add_buff', buffId: 'yu_du_shu' }],
    },
    {
        id: 'yi_ma_xin_yuan',
        name: '意马心猿',
        ...
        tags: ['debuff'],
        effects: [{ type: 'add_buff', buffId: 'yi_ma_xin_yuan' }],
    },
    {
        id: 'tongtian',
        name: '通天录',
        ...
        tags: ['debuff'],
        effects: [{ type: 'add_buff', buffId: 'tongtian' }],
    },
    {
        id: 'no_parry_style',
        name: '流风回雪',
        ...
        tags: ['buff', 'defense'],
        effects: [{ type: 'add_buff', buffId: 'no_parry_buff' }],
    },
    {
        ...
        tags: ['buff'],
        effects: [{ type: 'add_buff', buffId: 'draw_sword_combo_buff' }],
    },
    {
        id: 'dan_dao_fa_xuan',
        name: '单刀法选',
    ...
    // ── 白驹过隙（由「匆匆一瞥」拆分而来：身法→爆伤，3米内） ──
    {
        ...
        tags: ['buff'],
        effects: [{ type: 'add_buff', buffId: 'bai_ju_guo_xi_buff' }],
    },
    // ── 抽刀断水（暴击破气：打断对方 AP 与回复，纯扣不给缠） ──
    {
        ...
        tags: ['debuff'],
        effects: [{ type: 'add_buff', buffId: 'chou_dao_duan_shui_buff' }],
    },
    {
        ...
        tags: ['buff'],
        effects: [{ type: 'add_buff', buffId: 'jing_luo_chu_jian' }],
    },
    {
        id: 'dian_xue_passive',
        name: '灵枢真解',
        ...
        effects: [{ type: 'add_buff', buffId: 'ling_xu_zhen_jie' }],
    },
    {
        id: 'li_wu_xu_fa',
        name: '例无虚发',
        ...
        tags: ['buff', 'thrown'],
        effects: [{ type: 'add_buff', buffId: 'li_wu_xu_fa' }],
    },
    // ── 酒鬼·无志 ──
    {
        id: 'zui_quan',
        ...
        effects: [{ type: 'add_buff', buffId: 'zui_quan_dodge' }],
    },
    {
    ...
    },
    {
        ...
        effects: [{ type: 'add_buff', buffId: 'hun_yuan_gong_buff' }],
    },
    {
    ...
    },
    {
        ...
        tags: ['buff'],
        effects: [{ type: 'add_buff', buffId: 'sword_focus' }],
    },
    {
        id: 'drunken_step',
        name: '醉仙望月步',
    ...
    },
    {
        ...
        tags: ['qi', 'inherent'],
        effects: [{ type: 'add_buff', buffId: 'ningqi_jue_attr' }],
        actionEnhancer: (def) => {
    ...
    },
    {
        ...
        tags: ['buff', 'qi'],
        effects: [{ type: 'add_buff', buffId: 'rui_qi_jue' }],
    },
    {
        id: 'sword_capture',
        name: '无刀取',
    ...
    },
    {
        ...
        tags: ['buff', 'chan'],
        effects: [{ type: 'add_buff', buffId: 'ru_yi_jin' }],
    },
    {
        id: 'blood_rage',
        name: '血战到底',
        ...
        tags: ['buff', 'low_hp'],
        effects: [{ type: 'add_buff', buffId: 'blood_rage' }],
    },
    {
        id: 'gear_shift',
        name: '挂挡',
    ...
    },
    {
        ...
        tags: ['buff', 'low_hp'],
        effects: [{ type: 'add_buff', buffId: 'shen_zhao_jing' }],
    },
    {
        id: 'karate',
        name: '空手道',
        ...
        tags: ['buff', 'unarmed'],
        effects: [{ type: 'add_buff', buffId: 'karate' }],
    },
    {
        id: 'fei_hua_shou',
        name: '漫天花雨',
        ...
        effects: [{ type: 'add_buff', buffId: 'fei_hua_shou' }],
    },
    {
        id: 'lian_da_mi_jue',
        name: '练打秘诀',
        ...
        requireAttrsMin: { dexterity: 16 },
        effects: [{ type: 'add_buff', buffId: 'lian_da_mi_jue' }],
    },
    // ── 毒药大师（唐柔·唐门制毒） ──
    {
        id: 'du_yao_da_shi',
        ...
        effects: [{ type: 'add_buff', buffId: 'du_yao_da_shi' }],
    },
    {
        id: 'sekai_heroism',
        name: '舍得心法',
        ...
        tags: ['buff'],
        effects: [{ type: 'add_buff', buffId: 'sekai_heroism_attr' }],
    },
    {
        id: 'combat_instinct',
        name: '本能特训',
    ...
    },
    {
        ...
        tags: ['buff', 'defense'],
        effects: [{ type: 'add_buff', buffId: 'insight_awareness' }],
    },
    {
        id: 'wolf_hunting',
        name: '苍狼劲',
        ...
        tags: ['buff', 'chan'],
        effects: [{ type: 'add_buff', buffId: 'wolf_hunting_buff' }],
    },
    {
        id: 'no_way_win',
        name: '无招胜有招',
        ...
        tags: ['buff'],
        effects: [{ type: 'add_buff', buffId: 'no_way_win_buff' }],
    },
    {
        ...
        tags: ['buff'],
        effects: [{ type: 'add_buff', buffId: 'ling_long_xin_qiao_buff' }],
    },
    {
        id: 'autumn_water',
        name: '秋水论',
    ...
    },
    {
        ...
        tags: ['defense', 'chan'],
        effects: [{ type: 'add_buff', buffId: 'bu_dong_ming_wang_buff' }],
    },
    {
    ...
    },
    {
        ...
        tags: ['buff', 'defense'],
        effects: [{ type: 'add_buff', buffId: 'enhanced_vision_buff' }],
    },
    // ── 炁电转换（天工·千星） ──
    {
    ...
    // ── 无明之明 ──
    {
        ...
        tags: ['buff', 'defense'],
        effects: [{ type: 'add_buff', buffId: 'no_light_buff' }],
    },
    {
        id: 'ru_shen_zuo_zhao',
        name: '入神坐照',
    ...
    // ── 姬然 ──
    {
        ...
        tags: ['buff', 'low_hp'],
        effects: [{ type: 'add_buff', buffId: 'guan_zi_zai_yan' }],
    },
    // ── 禅子 · 禅修 ──
    {
        id: 'yi_jin_jing',
        ...
        tags: ['buff'],
        effects: [{ type: 'add_buff', buffId: 'yi_jin_jing_attr' }],
    },
    {
        ...
        tags: ['buff', 'chan'],
        effects: [{ type: 'add_buff', buffId: 'chanzi_chan_regen' }],
    },
    {
        id: 'chan_ding',
        name: '朱雀定',
