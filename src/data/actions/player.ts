...
export const PLAYER_ACTIONS: ActionDefinition[] = [
    ...
    },
    {
        ...
        hookNotes: { hitChance: '+15%', critChance: '+20%' },
        effects: [
            { type: 'damage', scaling: { wisdom: 2 }, piercingRatio: 0.5 },
    ...
    },
    {
        ...
        hookNotes: { hitChance: '+10%', critChance: '+30%' },
        effects: [{ type: 'damage', scaling: { strength: 1, dexterity: 0.8, agility: 0.8 } }],
    },
    {
        id: 'stand_rod_kick',
        name: '立棍踢',
    ...
    // ── 御物系 ──
    {
        ...
        onActionHitChance: (base) => base + 0.1,
        hookNotes: { hitChance: '+10%' },
        effects: [{ type: 'damage', scaling: { wisdom: 0.24 }, fixed: 2, independentHits: 5 }],
    },
    {
        id: 'wan_fa_gui_yi',
        name: '万法归一',
